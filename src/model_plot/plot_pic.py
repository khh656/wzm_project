...
def plot_result(ori_path, ori_file, res_file, result_path):
    ...
    one_path_file = r'G:\wu xianbei\wzm_project\data_0712\redis.csv'
    des_path_file = r'G:\wu xianbei\wzm_project\data_0712\result_weight_score_0712\one_file_weight2.csv'
    EWM_scores_weight(one_path_file, des_path_file)
    # 其次，根据结果，画图
    ori_file = r'G:\wu xianbei\wzm_project\data_0712\result_weight_score_0712\one_file_weight2.csv'
